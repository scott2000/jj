...
fn test_report_conflicts() {
    ...
    Working copy  (@) now at: zsuskuln ea1da3b3 (conflict) (empty) (no description set)
    Parent commit (@-)      : kkmpptxz a0487d65 (conflict) C
    Added 0 files, modified 1 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:
    file    2-sided conflict including 1 deletion
    New conflicts appeared in 2 commits:
      kkmpptxz a0487d65 (conflict) C
      rlvkpnrz 5e2f71ee (conflict) B
    ...
    Working copy  (@) now at: zsuskuln 64916b3f (conflict) (empty) (no description set)
    Parent commit (@-)      : kkmpptxz bcef66cb (conflict) C
    Added 0 files, modified 1 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:
    file    2-sided conflict
    New conflicts appeared in 2 commits:
      kkmpptxz bcef66cb (conflict) C
      rlvkpnrz 2343d8a7 (conflict) B
    Hint: To resolve the conflicts, start by creating a commit on top of
    ...
    insta::assert_snapshot!(output, @r"
    ------- stderr -------
    Working copy  (@) now at: vruxwmqv 0978eeb3 (conflict) (empty) (no description set)
    Parent commit (@-)      : rlvkpnrz 2343d8a7 (conflict) B
    Added 0 files, modified 1 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:
    file    2-sided conflict including 1 deletion
    [EOF]
...
fn test_report_conflicts_with_divergent_commits() {
    ...
    Rebased 3 commits to destination
    Working copy  (@) now at: zsuskuln/1 ad54c5cd (divergent) (conflict) C2
    Parent commit (@-)      : kkmpptxz 1c81c09a (conflict) B
    Added 0 files, modified 1 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:
    file    2-sided conflict including 1 deletion
    New conflicts appeared in 3 commits:
      zsuskuln/0 ac4678be (divergent) (conflict) C3
      zsuskuln/1 ad54c5cd (divergent) (conflict) C2
      kkmpptxz 1c81c09a (conflict) B
    Hint: To resolve the conflicts, start by creating a commit on top of
    the first conflicted commit:
      jj new kkmpptxz
    Then use `jj resolve`, or edit the conflict markers in the file directly.
    ...
    ------- stderr -------
    Rebased 1 commits to destination
    Working copy  (@) now at: zsuskuln/0 1bb3e74a (divergent) (conflict) C2
    Parent commit (@-)      : zzzzzzzz 00000000 (empty) (no description set)
    Added 0 files, modified 1 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:
    file    2-sided conflict including 1 deletion
    New conflicts appeared in 1 commits:
      zsuskuln/0 1bb3e74a (divergent) (conflict) C2
    Hint: To resolve the conflicts, start by creating a commit on top of
    ...
    Rebased 1 commits to destination
    New conflicts appeared in 1 commits:
      zsuskuln/0 19c281dd (divergent) (conflict) C3
    Hint: To resolve the conflicts, start by creating a commit on top of
    the conflicted commit:
      jj new zsuskuln
    Then use `jj resolve`, or edit the conflict markers in the file directly.
