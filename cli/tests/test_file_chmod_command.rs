...
fn test_chmod_regular_conflict() {
    ...
    Working copy  (@) now at: yostqsxw 83d5992f conflict | (conflict) conflict
...
fn test_chmod_file_dir_deletion_conflicts() {
    ...
    insta::assert_snapshot!(output, @r"
    ------- stderr -------
    Working copy  (@) now at: kmkuslsw 9d40c0ef file_deletion | (conflict) file_deletion
    ...
    New conflicts appeared in 1 commits:
      kmkuslsw 9d40c0ef file_deletion | (conflict) file_deletion
