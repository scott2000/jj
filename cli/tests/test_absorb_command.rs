...
fn test_absorb_simple() {
    ...
    ○    kkmpptxz 5810eb0f 1
    ├─╮
    │ ○  yqosqzyt/0 39b42898 (no description set)
    │ ○  yqosqzyt/1 977269ac (empty) (no description set)
    ○    kkmpptxz/1 bd7d4016 1
    ├─╮
    │ ○  mzvwutvl/0 0b307741 (no description set)
    │ ○  mzvwutvl/1 f2709b4e (empty) (no description set)
    ○  kkmpptxz/2 1553c5e8 1
    ○  kkmpptxz/3 eb943711 (empty) 1
    [EOF]
    ");
    insta::assert_snapshot!(get_evolog(&work_dir, "description(2)"), @r"
    ○    zsuskuln dd109863 2
    ├─╮
    │ ○  vruxwmqv/0 761492a8 (no description set)
    │ ○  vruxwmqv/1 48c7d8fa (empty) (no description set)
    ○  zsuskuln/1 8edd60a2 2
    ○    zsuskuln/2 95568809 2
    ├─╮
    │ ○  mzvwutvl/0 0b307741 (no description set)
    │ ○  mzvwutvl/1 f2709b4e (empty) (no description set)
    ○  zsuskuln/3 36fad385 2
    ○  zsuskuln/4 561fbce9 (empty) 2
    [EOF]
    ");
}
