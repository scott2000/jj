...
fn test_git_push_revert() {
    ...
    main: qpvuntsm d9a9f6a0 (empty) BB
      @origin (ahead by 1 commits, behind by 1 commits): qpvuntsm/1 3a44d6c5 (empty) AA
    [EOF]
    ");
...
fn test_git_push_revert_with_import() {
    ...
    main: qpvuntsm 1e742089 (empty) CC
      @origin (ahead by 1 commits, behind by 1 commits): qpvuntsm/1 d9a9f6a0 (empty) BB
    [EOF]
    ");
}
