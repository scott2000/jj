...
fn test_rewrite_immutable_commands() {
    ...
    │  (no description set)
    │ ◆  mzvwutvl test.user@example.com 2001-02-03 08:05:12 main c7ad5ccf (conflict)
    ╭─┤  merge
    │ │
    │ ~
    │
    ...
    insta::assert_snapshot!(output, @r#"
    ------- stderr -------
    Error: Commit c7ad5ccfaba5 is immutable
    Hint: Could not modify commit: mzvwutvl c7ad5ccf main | (conflict) merge
    Hint: Immutable commits are used to protect shared history.
    Hint: For more information, see:
          - https://docs.jj-vcs.dev/latest/config/#set-of-immutable-commits
          - `jj help -k config`, "Set of immutable commits"
