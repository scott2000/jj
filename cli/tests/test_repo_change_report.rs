...
fn test_report_conflicts() {
    ...
    Working copy now at: zsuskuln b30ced7e (conflict) (empty) (no description set)
    ...
    Working copy now at: zsuskuln 2ec97265 (empty) (no description set)
    ...
    Once the conflicts are resolved, you may want inspect the result with `jj diff`.
    Then run `jj squash` to move the resolution into the conflicted commit.
    Working copy now at: zsuskuln 06186190 (conflict) (empty) (no description set)
