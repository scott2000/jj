...
fn test_workspaces_conflicting_edits() {
    ...
    Working copy now at: pmmvwywv?? 0feea507 (empty) (no description set)
    ...
    │ ◉  e82cd4ee8faa default@
    ├─╯
    │ @  0feea5071ad8 secondary@ (divergent)
    ├─╯
    ◉  d41244767d45
    ◉  000000000000
    "###);
...
fn test_workspaces_current_op_discarded_by_other() {
    ...
    insta::assert_snapshot!(stdout, @r###"
    @  456cf83974 abandon commit 3540d386892997a2a927078635a2d933e37499fb8691938a2f540c25bccffd9e8a60b2d5a8cb94bb3eeab17e1c56f96aafa2bcb66fa1e4eb96911d093d7a579e
    ...
    insta::assert_snapshot!(get_log_output(&test_env, &main_path), @r###"
    @  efc6366f8dd3 default@
    │ ◉  3bfaadca71aa secondary@
    ├─╯
    ◉  7788883a847c
    ◉  000000000000
    "###);
    ...
    Created and checked out recovery commit 3a58a44405d0
    "###);
    insta::assert_snapshot!(stdout, @"");

    insta::assert_snapshot!(get_log_output(&test_env, &main_path), @r###"
    ◉  ed487c4e2c73 secondary@
    ◉  3bfaadca71aa
    │ @  efc6366f8dd3 default@
    ├─╯
    ◉  7788883a847c
    ...
    D deleted
    M modified
    Working copy : kmkuslsw ed487c4e (no description set)
    Parent commit: rzvqmyuk 3bfaadca (empty) (no description set)
    "###);
    ...
    insta::assert_snapshot!(stderr, @"");
    insta::assert_snapshot!(stdout, @r###"
    @  kmkuslsw test.user@example.com 2001-02-03 08:05:18 secondary@ ed487c4e
    │  (no description set)
    ◉  kmkuslsw hidden test.user@example.com 2001-02-03 08:05:18 3a58a444
